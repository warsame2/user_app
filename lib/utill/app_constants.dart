import 'package:user_app/localization/models/language_model.dart';
import 'package:user_app/utill/images.dart';

class AppConstants {
  static const String appName = 'alfajri';
  static const String slogan = 'aa';
  static const String appVersion = '2';

  static const String baseUrl = 'https://alfajri.so';
  static const String imageUrl = "$baseUrl/storage/app/public/product/";
  static const String userId = '1';
  static const String name = 'Asthama Honey';
  ...
  static const String verifyPhoneUrii = 'https://www.alfajri.so/api/v1/auth/verify-code';
