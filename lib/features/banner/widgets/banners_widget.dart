...
import 'package:user_app/features/banner/widgets/banner_shimmer.dart';
      ...
      children: [
        Consumer<BannerController>(
          builder: (context, bannerProvider, child) {
            ...
            // print("${bannerProvider.mainBannerList}_____________WWWW");
            return Stack(
              children: [
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Container(
                                              ...
                                              child: CustomImageWidget(
                                                  image:
                                                      'https://alfajri.so/storage/app/public/banner/${bannerProvider.mainBannerList?[index].photo}')),
                                        ),
                                      );
                                    },
                                  ),
